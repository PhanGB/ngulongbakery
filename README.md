...
### Cho Khách Hàng
- **Xem & Tìm Kiếm Sản Phẩm**: Duyệt danh sách bánh, tìm kiếm theo từ khóa
...
- **Sản Phẩm Yêu Thích**: Lưu sản phẩm yêu thích
...
- **Quản Lý Banner**: Quản lý hình ảnh quảng cáo trên trang chủ
...
Dự án này có thể có giấy phép riêng - vui lòng kiểm tra tệp LICENSE trong repository (nếu có).
...
- Email: taolaai2468@gmail.com (hoặc kiểm tra repository)
